  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#fffbeb_0%,#fff7ed_55%,#f7fee7_100%)]">
      <section className="mx-auto grid max-w-6xl gap-6 px-4 py-6 sm:px-5 md:py-8">
        <CommercialAdminHero eyebrow="Gestão interna" title="Menu" description="Cadastro e gestão dos menus da plataforma e dos clientes." />
        ...
        <section className="rounded-[2rem] border border-amber-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="mt-3 max-w-4xl text-sm leading-6 text-stone-700">Mantém a lógica já validada no Tucxa: cada módulo pode ter menu, hierarquia, ordem, página vinculada e status de uso por cliente/evento.</p>
        </section>
