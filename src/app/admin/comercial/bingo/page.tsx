  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#fffbeb_0%,#fff7ed_55%,#f7fee7_100%)]">
      <section className="mx-auto grid max-w-6xl gap-6 px-4 py-6 sm:px-5 md:py-8">
        <CommercialAdminHero eyebrow="Gestão interna" title="Bingo no Controle" description="Produto comercial próprio dentro da plataforma." />
        <CommercialAdminNav currentHref="/admin/comercial/bingo" />
        <section className="rounded-[2rem] border border-amber-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <h2 className="mt-2 text-2xl font-black text-green-950">Bingo no Controle</h2>
          <p className="mt-3 max-w-4xl text-sm leading-6 text-stone-700">Pode ser vendido sozinho ou combinado ao Festa no Controle: rodadas, várias quinas, cartela cheia, prendas, conferência de bingo, TVs, som e venda de cartelas.</p>
        </section>
