  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#fffbeb_0%,#fff7ed_55%,#f7fee7_100%)] lg:pl-72">
      <section className="mx-auto grid max-w-6xl gap-6 px-4 py-6 sm:px-5 md:py-8">
        <CommercialAdminHero eyebrow="Gestão interna" title="Configurações" description="Parâmetros da operação comercial." />
        <CommercialAdminNav currentHref="/admin/comercial/configuracoes" />
        <section className="rounded-[2rem] border border-amber-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <h2 className="mt-2 text-2xl font-black text-green-950">Configurações</h2>
          <p className="mt-3 max-w-4xl text-sm leading-6 text-stone-700">Centralize mensagens, BotConversa, e-mail, regras de follow-up, permissões, premissas de implantação e preferências da gestão interna.</p>
        </section>
